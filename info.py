...
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1002469255122'))  
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1002469255122'))  
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1002469255122')) 
auth_grp = environ.get('AUTH_GROUP')
AUTH_GROUPS = [int(ch) for ch in auth_grp.split()] if auth_grp else None
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002469255122') 
...
AUTH_REQ_CHANNEL = environ.get('AUTH_REQ_CHANNEL', '0') # add multiple channels here, separated by single space

IS_VERIFY = is_enabled('IS_VERIFY', False)
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '-1002469255122'))
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1002469255122'))
